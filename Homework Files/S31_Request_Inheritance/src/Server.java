...
public class Server {
    ...
    public static void main(String argv[]) {
        ...
        System.out.println("Total Requests: " + Request.returnCount());
        System.out.println("Get Requests: " + GetRequest.returnCount());
        System.out.println("Post Requests: " + PostRequest.returnCount());
        System.out.println("Post Form Requests: " + PostFormRequest.returnCount());
        System.out.println("Post Encrypted Form Requests: " + PostEncryptedFormRequest.returnCount());
        System.out.println("Post Payment Requests: " + PostPaymentRequest.returnCount());
        System.out.println("Post Encrypted Payment Requests: " + PostEncryptedPaymentRequest.returnCount());
        System.out.println("Get File Requests: " + GetFileRequest.returnCount());
        System.out.println("Get Video Requests: " + GetVideoRequest.returnCount());
    }
}
